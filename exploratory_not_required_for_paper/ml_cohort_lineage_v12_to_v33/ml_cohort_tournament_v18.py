"""
BCI Systems Engineering - Cohort-Scale Machine Learning Tournament (v18)
=============================================================================
Author: Kaushik Pratap Singh (Principal Investigator)

VERSION: v18 -- Introduces Multi-Scale Riemannian Fusion (MSRF). It preserves 
                the 4x4 global cross-talk manifold while simultaneously packing 
                localized 2x2 left and right hemispheric sub-manifolds into a 
                unified geometric feature vector.
"""
...
def main():
    ...
    print("\n" + "=" * 125)
    print(" 🚀 INITIATING COHORT-SCALE RIEMANNIAN ML TOURNAMENT (v18 - MULTI-SCALE MANIFOLD FUSION)")
    print("=" * 125)
    ...
    for sid in subject_ids:
        try:
            ...
            # Compute balanced Multi-Scale Joint Riemannian Means
            ...
            for c_glob, c_left, c_right, spec in zip(temp_act_global_covs, temp_act_left_covs, temp_act_right_covs, temp_active_spectral):
                ...
                ts_global = project_to_tangent_space(c_glob, M_joint_global)
                ts_left   = project_to_tangent_space(c_left, M_joint_left)
                ts_right  = project_to_tangent_space(c_right, M_joint_right)
                
                # Fusion of Global (10 dims) + Left Subspace (3 dims) + Right Subspace (3 dims)
            ...
            # The multi-scale fusion block spans 16 dimensions (10 + 3 + 3)
    ...
    print("\n" + "=" * 125)
    print(" 🏆 FINAL TOURNAMENT BENCHMARK COMPARISON REPORT (v18 - MULTI-SCALE MANIFOLD FUSION)")
    print("=" * 125)
