"""
BCI Systems Engineering - Cohort-Scale Machine Learning Tournament (v26)
=============================================================================
Author: Kaushik Pratap Singh (Principal Investigator)

VERSION: v26 -- Geometric Preservation via Selective Scaling.
                Bypasses StandardScaler() in the TSA-SVM pipeline to prevent
                column-wise variance normalization from flattening the 
                globally scaled Riemannian manifolds, while keeping standard 
                scaling intact for raw features.
"""
...
def main():
    ...
    print("\n" + "=" * 125)
    print(" 🚀 INITIATING COHORT-SCALE RIEMANNIAN ML TOURNAMENT (v26 - SELECTIVE SCALING)")
    print("=" * 125)
    ...
    # Expanded search grid to map the compressed L2 spatial boundaries
    svm_param_grid = {
        'svm__C': [1.0, 10.0, 100.0, 500.0, 1000.0],
        'svm__gamma': ['scale', 0.005, 0.01, 0.05, 0.1, 0.5]
    }
    ...
    for test_sid in unique_groups:
        ...
        # 2. Raw SVM Pipeline (Requires column-wise StandardScaler)
        ...
        # 3. TSA SVM Pipeline (Bypasses StandardScaler to protect global geometric proportions)
    ...
    print("\n" + "=" * 125)
    print(" 🏆 FINAL TOURNAMENT BENCHMARK COMPARISON REPORT (v26 - SELECTIVE SCALING)")
    print("=" * 125)
