"""
BCI Systems Engineering - Cohort-Scale Machine Learning Tournament (v32)
=============================================================================
Author: Kaushik Pratap Singh (Principal Investigator)

VERSION: v32 -- Fixes the scikit-learn t-SNE initialization parameter error.
"""
...
def main():
    ...
    print("\n" + "=" * 125)
    print(" 🚀 INITIATING COHORT-SCALE RIEMANNIAN ML TOURNAMENT (v32 - TASK-CONDITIONAL MANIFOLD CENTERING)")
    print("=" * 125)
    ...
    print("\n" + "=" * 125)
    print(" 🏆 FINAL TOURNAMENT BENCHMARK COMPARISON REPORT (v32 - HONEST COHORT MEANS)")
    print("=" * 125)
    ...
    try:
        # Removed n_iter parameter to prevent scikit-learn parameter matching conflicts
