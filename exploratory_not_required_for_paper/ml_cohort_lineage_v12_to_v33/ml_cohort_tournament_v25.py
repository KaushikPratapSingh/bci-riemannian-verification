"""
BCI Systems Engineering - Cohort-Scale Machine Learning Tournament (v25)
=============================================================================
Author: Kaushik Pratap Singh (Principal Investigator)

VERSION: v25 -- Global Magnitude Scaling with Granular RBF Expansion.
                Retains the mathematically precise global scalar divisor from v24
                to protect directional geometry, while expanding the inner-loop
                cross-validation search boundaries (C up to 1000.0, wider gamma)
                to resolve the hyperparameter saturation bottleneck.
"""
...
def main():
    ...
    print("\n" + "=" * 125)
    print(" 🚀 INITIATING COHORT-SCALE RIEMANNIAN ML TOURNAMENT (v25 - GRANULAR RBF EXPANSTION)")
    print("=" * 125)
    ...
    # -----------------------------------------------------------------
    # EXPANDED KERNEL SEARCH SPACE (v25 Scale Realignment)
    # -----------------------------------------------------------------
    svm_param_grid = {
    ...
    print("\n" + "=" * 125)
    print(" 🏆 FINAL TOURNAMENT BENCHMARK COMPARISON REPORT (v25 - GRANULAR RBF EXPANSTION)")
    print("=" * 125)
