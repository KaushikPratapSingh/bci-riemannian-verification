"""
BCI Systems Engineering - Cohort-Scale Machine Learning Tournament (v20)
=============================================================================
Author: Kaushik Pratap Singh (Principal Investigator)

VERSION: v20 -- Introduces Information-Theoretic Manifold Fusion. It computes
                the intrinsic Riemannian dispersion of individual trial matrices 
                relative to their sub-manifold means (Global, Left, Right). It then 
                uses an exponential inverse-dispersion mapping to assign localized 
                attention weights to each space before tangent vector concatenation.
"""
...
def main():
    ...
    print("\n" + "=" * 125)
    print(" 🚀 INITIATING COHORT-SCALE RIEMANNIAN ML TOURNAMENT (v20 - INFORMATION-THEORETIC FUSION)")
    print("=" * 125)
    ...
    for sid in subject_ids:
        try:
            ...
            # Compute intrinsic sub-manifold dispersion across all active + rest trials
            ...
            # Apply Softmax-style Information Attention Mapping
            ...
            print(f"  Processed Subject S{sid:02d} | Weights: G={w_global:.2f}, L={w_left:.2f}, R={w_right:.2f} | Alpha: {alpha_s:.3f}")
    ...
    print("\n" + "=" * 125)
    print(" 🏆 FINAL TOURNAMENT BENCHMARK COMPARISON REPORT (v20 - INFORMATION-THEORETIC FUSION)")
    print("=" * 125)
